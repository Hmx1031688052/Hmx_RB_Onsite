...
class RuleBasedPlanner(object):
    ...
    def _build_sprint_path(self, ego, global_path):
        ...
        start_x = _finite(getattr(ego, "x", 0.0))
        start_y = _finite(getattr(ego, "y", 0.0))
        dx = goal_x - start_x
        dy = goal_y - start_y
    ...
    def _lateral_control(
        ...
        if centerline_control_active:
            ...
            if sprint_mode:
                ...
                active_lateral_accel_limit = abs(
                    centerline_lat_accel_command
                )
        ...
        self.last_debug.update(
            {
                ...
                "sprint_lateral_control": bool(sprint_mode),
