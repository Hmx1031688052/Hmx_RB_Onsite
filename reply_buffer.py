...
class Reply_Buffer():
    ...
    def sample(self, batch_size):
        ...
        batch_state, batch_action, batch_reward, batch_state_new, batch_over, batch_logp = [], [], [], [], [], []
        for b in batch:
        ...
        return batch_state, batch_action, batch_reward, batch_state_new, batch_over, batch_logp
